package com.example.demo.diy_view;
...
public class GradientCircleProgress extends View {
    ...
    public GradientCircleProgress(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradientCircleProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GradientCircleProgress);
        progressWidth = a.getDimensionPixelOffset(R.styleable.GradientCircleProgress_progress_width, DEFAULT_PROGRESS_WIDTH);
        progressBgColor = a.getColor(R.styleable.GradientCircleProgress_progress_bg_color, DEFAULT_PROGRESS_BG_COLOR);
        progressColor = a.getColor(R.styleable.GradientCircleProgress_progress_color, DEFAULT_PROGRESS_COLOR);
        progress = a.getInteger(R.styleable.GradientCircleProgress_progress, DEFAULT_PROGRESS);
        circleTextColor = a.getColor(R.styleable.GradientCircleProgress_circle_text_color, DEFAULT_TEXT_COLOR);
        circleTextSize = a.getDimensionPixelOffset(R.styleable.GradientCircleProgress_circle_text_size, DEFAULT_TEXT_SIZE);
        isVisibleText = a.getBoolean(R.styleable.GradientCircleProgress_isVisibleText, false);
        locationStart = a.getInt(R.styleable.GradientCircleProgress_location_start, 2);
        a.recycle();
